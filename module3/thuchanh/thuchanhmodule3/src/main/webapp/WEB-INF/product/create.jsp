                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form class="form-horizontal" method="post" action="/products?action=create">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 control-label" for="idPrice" required>Price</label>
                                    <div class="col-md-10">
                                        <input type="text" id="idPrice" name="price" class="form-control" placeholder="price">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 control-label" for="idQuantily" required>Quantily</label>
                                    <div class="col-md-10">
                                        <input type="text" id="idQuantily" name="quantily" class="form-control" placeholder="quantily">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 control-label" for="idColor" required>Color</label>
                                    <div class="col-md-10">
                                        <input type="text" id="idColor" name="color" class="form-control" placeholder="color">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 control-label" for="idStatus" required>Status</label>
                                    <div class="col-md-10">
                                        <input aria-label="" id="idStatus" name="status" class="form-control" placeholder="status">
                                    </div>
                                </div>
                                <div class="form-group row">
