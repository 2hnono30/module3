...
public class UserDAO implements IUserDAO{
    ...
    public User selectUser(int id) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                user = new com.example.usermanager.model.User(id, name, email, country);
            }
        } catch (SQLException e) {
            printSQLException(e);
        }
    ...
    public List<com.example.usermanager.model.User> selectAllUsers() {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                String email = rs.getString("email");
                String country = rs.getString("country");
                users.add(new com.example.usermanager.model.User(id, name, email, country));
            }
        } catch (SQLException e) {
            printSQLException(e);
        }
    ...
    @Override
    public boolean updateUser(com.example.usermanager.model.User user) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = getConnection();
